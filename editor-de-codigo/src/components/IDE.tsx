...
export default function IDE() {
  ...
  const handleRunTests = async () => {
    ...
    // Simulate test run — replace with your real test runner
  ...
  return (
    <ThemeContext.Provider value={{ theme, toggleTheme }}>
      ...
      >
        ...
        {/* ── Secondary menu (Edit / Selection / View / Go / Preview) ── */}
        <div
        ...
        <div
          ...
          style={{ height: "calc(100vh - 22px - 36px - 28px)" }}
        >
          <LeftPanel />
          <ActivityBar />
          ...
          <div className="flex flex-col flex-1 h-full min-w-0">
            ...
            >
              <details
                open={isQuestionOpen}
                onToggle={(e) =>
                  setIsQuestionOpen((e.currentTarget as HTMLDetailsElement).open)
                }
              >
                ...
                <div
                  className="px-4 pb-3 text-[12px] max-h-56 overflow-auto"
            ...
            {/* Terminal */}
            <div
              className="h-64 border-t flex flex-col shrink-0"
              style={{
            ...
            {/* ── Bottom action bar: Run Tests + Submit Code ── */}
            <div
